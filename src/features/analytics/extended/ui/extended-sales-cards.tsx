...
export function ExtendedSalesCards({
  ...
  const cards: CardConfig[] = [
    {
      label: "Gross Sales",
      value: fmtCompactMajor(data.grossSalesMinor.current / 100, "NGN"),
      delta: data.grossSalesMinor,
      icon: <TbCurrencyNaira size={14} />,
      iconColor: "text-violet-500",
      prevLabel: fmtCompactMajor(data.grossSalesMinor.previous / 100, "NGN"),
    },
    {
      label: "Net Sales",
      value: fmtCompactMajor(data.netSalesMinor.current / 100, "NGN"),
      delta: data.netSalesMinor,
      icon: <FiShoppingBag size={14} />,
      iconColor: "text-blue-500",
      prevLabel: fmtCompactMajor(data.netSalesMinor.previous / 100, "NGN"),
    },
    {
      label: "Avg Order Value",
      value: fmtCompactMajor(data.aov.current / 100, "NGN"),
      delta: data.aov,
      icon: <TbCurrencyNaira size={14} />,
      iconColor: "text-cyan-500",
      prevLabel: fmtCompactMajor(data.aov.previous / 100, "NGN"),
    },
    {
      label: "Discounts",
      value: fmtCompactMajor(data.discountTotalMinor.current / 100, "NGN"),
      delta: data.discountTotalMinor,
      icon: <FiTag size={14} />,
      iconColor: "text-amber-500",
      invertGood: true,
      prevLabel: fmtCompactMajor(data.discountTotalMinor.previous / 100, "NGN"),
    },
    {
